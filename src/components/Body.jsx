  ...
  return (
    ...
    data-aos-easing="ease-in-out">Vous voulez que votre prochain événement se démarque ?</p>
        <div className=' w-1/2  max-sm:w-11/12 max-sm:py-4' >
            <p className='text-[#e25d1f]/50 text-3xl mb-1 max-sm:text-2xl max-sm:text-center max-sm:my-6 uppercase'
             data-aos="slide-up"
    data-aos-duration="1000"
    ...
    data-aos-easing="ease-in-out" />
            <div className='w-1/2 py-14 max-sm:py-3 bg-[#e25d1f]/30 grid grid-cols-2 gap-4 p-4 max-sm:w-full max-sm:grid-cols-1 max-sm:my-4'>
...
Avec Elikiabooth, vos plus beaux souvenirs se partagent en un clic !</p>
      ...
      <div className='w-full flex flex-col items-center justify-center my-8 py-8'>
        <p className='text-[#e25d1f]/50 text-xl max-sm:hidden my-2'>NOS SÉLECTIONS</p>
    ...
    data-aos-easing="ease-in-out"
          >
            ...
            <div className='absolute bottom-0 left-0 right-0 bg-[#e25d1f]  text-[#271a02] text-center p-4 text-4xl max-sm:text-2xl'>{image.title}</div>
</div>))
         }
      </div>

      <div className='bg-[#e25d1f]/80 w-full py-8 max-sm:my-1 my-8 grid grid-cols-4 max-sm:grid-cols-1 gap-4 max-sm:gap-2 items-center justify-center'>
        {
      ...
      <div className='w-full flex flex-col justify-center items-center max-sm:my-0 my-12 max-sm:hidden'>
        <h1 className='text-center text-2xl text-[#e25d1f]/50 my-3 uppercase'>Photobooth personnalisé</h1>
...
data-aos="slide-up"
    ...
    data-aos-easing="ease-in-out">Mariage, anniversaire ou événement corporatif, Elikiabooth a tout ce qu’il vous faut pour capturer chaque sourire et chaque moment de joie.</p>
        ...
        <div className='w-full  flex flex-col items-center justify-center max-sm:my-0 mt-2 bg-[#e25d1f]/40 py-8'>
