      ...
      <div className="relative w-full h-full after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-black after:opacity-50 after:z-20">
        ...
        <div className="w-full h-full absolute top-0 left-0 flex flex-col items-center justify-center z-30">
            <h1 className="text-white text-center text-[calc(3rem+1vw)] md:text-6xl font-bold ">Êtes-vous prêt à fêter avec style ?</h1> 
               <h3 className="text-white text-center text-[calc(1.5rem+1vw)] md:text-3xl font-semibold ">Bienvenue chez Fotobo, le meilleur service de location de Photobooth à Montréal.</h3>
