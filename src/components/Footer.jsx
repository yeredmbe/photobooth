    ...
    <>
      <div className='w-full'>
        <div className='w-full py-8 max-sm:py-2 bg-[#222221] flex justify-around max-sm:flex-col max-sm:items-center max-sm:justify-center '>
            <div className='flex items-center max-sm:my-3'><img src='./loaction.png' className='size-12 max-sm:size-8' /> <p className='text-xl max-sm:text-lg text-center text-white font-semibold ml-2'>Your Location</p> </div>
            <div className='flex items-center max-sm:my-3'><img src='./telephone.png' className='size-12 max-sm:size-8' /><p className='text-xl max-sm:text-lg text-center text-white font-semibold  ml-2'>Your Phone</p> </div>
            <div className='flex items-center max-sm:my-3'><img src='./mail.png' className='size-12 max-sm:size-8' /> <p className='text-xl max-sm:text-lg text-center text-white font-semibold  ml-2'>Your Email</p> </div>
        </div>
