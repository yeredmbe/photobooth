  ...
  return (
    <div>
       ...
       <div className='w-full relative after:content-[""] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-black/70 after:z-10 font-GaramondAntiqua'>
        ...
        <h1 className='text-8xl text-white my-3 max-sm:text-5xl max-sm:mx-2 uppercase'>Services événements</h1>
        <p className='text-3xl text-white max-sm:text-xl'>Les services de location de photobooth de Fotobo pour élever l'expérience de votre prochain événement.</p>
      ...
      <div className='w-full flex flex-col justify-center items-center max-sm:my-0 my-12 max-sm:hidden'>
        <h1 className='text-center text-2xl text-[#9e8121]/50 my-3  font-GaramondAntiqua'>Personnalisez votre photobooth</h1>
