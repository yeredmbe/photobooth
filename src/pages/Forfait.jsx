...
const Forfait = () => {
  return (
    ...
    <div className='fade'>
        ...
        <Link to="/contact">
         <button className="mt-6 mx-3 text-3xl max-sm:text-xl cursor-pointer px-6 py-3 bg-[#9e8121] border-[#9e8121] border  text-white font-medium hover:text-white hover:bg-transparent transition duration-500 hover:border-white ease-in-out">OBTENEZ UNE SOUMISSION RAPIDE</button>
         </Link>
        </div>
      </div>


      <div className='w-full flex flex-col bg-[#9e8121]/30 items-center justify-center my-2 py-8'>
       <div className='w-11/12 flex items-center justify-evenly max-sm:flex-col max-sm:items-center max-sm:justify-center'>
        <div className='p-3 w-1/2 max-sm:w-full'>
            <h1 className='text-5xl max-sm:text-3xl'>Photobooth Miroir Magique</h1>
            <div>
                ...
                <h2>Inclus dans ce forfait photobooth :</h2>
      ...
      <div className='w-11/12 my-8 grid grid-cols-3 max-sm:grid-cols-1 gap-6 max-sm:gap-4 px-4 max-sm:px-1'>
       ...
       <div className='w-full flex flex-col items-center justify-center my-2 py-8'>
       <div className='w-11/12 flex items-center justify-evenly max-sm:flex-col max-sm:items-center max-sm:justify-center'>
        <div className='p-3 w-1/2 max-sm:w-full'>
            <h1 className='text-5xl max-sm:text-3xl'>Photobooth Miroir Magique</h1>
            <div>
      ...
      <div className='w-11/12 my-8 grid grid-cols-3 max-sm:grid-cols-1 gap-6 max-sm:gap-4 px-4 max-sm:px-1'>
       ...
       <div className='w-11/12 flex items-center justify-evenly max-sm:flex-col max-sm:items-center max-sm:justify-center'>
        ...
        <p className='text-[#9e8121]/50 text-2xl my-3'>Les étapes clés</p>
        <div className='w-10/12 max-sm:w-full flex items-center justify-around max-sm:flex-col max-sm:items-center max-sm:justify-center'>
           ...
           <p className='text-4xl mx-8 max-sm:mx-3 text-center max-sm:px-3 max-sm:text-center max-sm:text-4xl'>Processus de location de photobooth</p>
           <hr className=' border-[#9e8121]/40 w-1/5 max-sm:hidden'/> 
        </div>
      </div>
...
<div className='w-full flex flex-col items-center justify-center my-2 py-8'>
      <div className='w-10/12 max-sm:px-4 max-sm:w-full py-7 max-sm:py-2 text-center flex items-center justify-around max-sm:flex-col max-sm:items-center max-sm:justify-between'>
        <div>
            <h1 className='text-7xl text-[#9e8121]/70'>01</h1>
            <p className='text-3xl my-2'>Demande de devis</p>
            <p>Remplissez notre formulaire avec les détails de votre Photobooth et de votre événement pour un devis personnalisé.</p>
        </div>

       <div className='mx-4 max-sm:mx-0 max-sm:my-6 '>
            <h1 className='text-7xl text-[#9e8121]/70'>02</h1>
            <p className='text-3xl my-2'>Réservation de service</p>
            <p>Nous vous contacterons le plus rapidement possible pour discuter de vos besoins, fixer la date de votre événement et commencer les préparatifs.</p>
        </div>

        <div>
            <h1 className='text-7xl text-[#9e8121]/70'>03</h1>
            <p className='text-3xl my-2'>Jour de l'événement</p>
            <p>Notre équipe livre, installe, assure une expérience sans faille et vous envoie un dossier cloud après l’événement.</p>
        </div>
      </div>
      </div>
      ...
      <div className='w-10/12 max-sm:px-4 max-sm:w-full py-7 max-sm:py-2 flex justify-center max-sm:flex-col max-sm:items-center max-sm:justify-between'>
      <div className='bg-black/80 py-8 px-5 w-1/2 max-sm:w-full'>
        ...
        <h1 className='text-white text-3xl '>Rôle du technicien</h1>
         ...
         <p className='text-2xl text-[#9e8121] my-2 max-sm:text-lg'>Nous proposons plusieurs options pour améliorer votre expérience du photobooth.</p>
         <div >
                    <ul className='text-white'>
       ...
       <div className='w-full flex items-center justify-center max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:px-0 max-sm:my-0 mt-5 max-sm:py-0 py-12 bg-[#9e8121]/40 px-24'>
      ...
      <div className='w-1/2 ml-16 max-sm:ml-0 max-sm:w-full max-sm:py-4 max-sm:text-center'>
        <h1 className='text-4xl my-5'>Pourquoi choisir Elikia Events?</h1>
