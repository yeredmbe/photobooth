...
const Forfait = () => {
  return (
    ...
    data-aos-easing="ease-in-out">Choisissez votre photobooth</h1>
        ...
        <Link to="/contact">
         <button className="mt-6 mx-3 text-3xl max-sm:text-xl cursor-pointer px-6 py-3 bg-[#e25d1f]/80 border-[#e25d1f] border  text-white font-medium hover:text-white hover:bg-transparent transition duration-500 hover:border-white ease-in-out">OBTENEZ UNE SOUMISSION RAPIDE</button>
         </Link>
        </div>
      </div>


      <div className='w-full flex flex-col bg-[#e25d1f]/30 items-center justify-center my-2 py-8 font-GaramondAntiqua '>
    ...
    data-aos-easing="ease-in-out">Libérez la magie avec notre DSLR Booth.</p>
                <hr className='bg-[#e25d1f]/80 border-2 border-[#e25d1f] w-1/5 max-sm:w-2/5 my-5 ' />
    ...
    data-aos-easing="ease-in-out">Inclus dans ce forfait photobooth :</h2>
                ...
                <div>
                    ...
                    <Link to="/contact">
         <button className="mt-6 mx-3 text-lg cursor-pointer px-6 py-3 bg-[#e25d1f] border-[#e25d1f] border  text-white font-medium hover:text-white hover:bg-black transition duration-500 hover:border-black ease-in-out">DEMANDER UN DEVIS</button>
         </Link>
                </div>
            </div>
        </div>
    ...
    data-aos-easing="ease-in-out">
                ...
                <hr className='bg-[#e25d1f] border border-[#e25d1f] w-1/5 my-5 ' />
    ...
    data-aos-easing="ease-in-out">
               ...
               <hr className='bg-[#e25d1f] border border-[#e25d1f] w-1/5 my-5 ' />
                <p className='text-6xl text-[#e25d1f] font-AdobeHebrew-italic'>449$</p>
                 <Link to="/contact">
         <button className="mt-6 mx-3 text-lg cursor-pointer px-6 py-3 bg-[#e25d1f] border-[#e25d1f] border  text-white font-medium hover:text-black hover:bg-white transition duration-500 hover:border-black ease-in-out">DEMANDER UN DEVIS</button>
         </Link>
            </div>
    ...
    data-aos-easing="ease-in-out">
                <p className='mt-2 font-Sans-Font max-sm:text-2xl'>6 HEURES DE SERVICE</p>
           <hr className='bg-[#e25d1f] border border-[#e25d1f] w-1/5 my-5 ' />
                <p className='text-6xl font-AdobeHebrew-italic text-[#271a02]'>549$</p>
                 <Link to="/contact">
         <button className="mt-6 mx-3 text-lg cursor-pointer px-6 py-3 bg-[#e25d1f] border-[#e25d1f] border  text-white font-medium hover:text-white hover:bg-black transition duration-500 hover:border-black ease-in-out">DEMANDER UN DEVIS</button>
         </Link>
            </div>
...
<div className='w-full flex flex-col items-center justify-center my-2 py-8 font-GaramondAntiqua'>
    ...
    data-aos-easing="ease-in-out">Complétez le formulaire et recevez votre devis personnalisé en un instant.</p>
     ...
     >
            <h1 className='text-9xl text-[#e25d1f]/70 font-AdobeHebrew-italic'   data-aos-delay="100"
    data-aos-duration="1000"
    ...
    data-aos-easing="ease-in-out">Nous vous contacterons le plus rapidement possible pour discuter de vos besoins, fixer la date de votre événement et commencer les préparatifs.</p>
      ...
      >
            <h1 className='text-9xl text-[#e25d1f]/70 font-AdobeHebrew-italic'   data-aos-delay="150"
    data-aos-duration="1000"
    ...
    data-aos-easing="ease-in-out"> Notre équipe s’occupe de tout : livraison, installation et envoi de vos souvenirs via le cloud.</p>
      ...
      <div className='w-full flex flex-col items-center justify-center mt-2 py-5 max-sm:py-2 bg-[#e25d1f]/30'>
    ...
    data-aos-easing="ease-in-out">Rôle du technicien</h1>
         <hr className='border border-[#e25d1f] w-1/5 my-2 '/> 
    ...
    data-aos-easing="ease-in-out">Services complémentaires</h1>
        ...
        <div className='w-full flex items-center justify-center max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:px-0 max-sm:my-0 my-12 max-sm:py-0 py-12 bg-[#e25d1f]/40 px-24'>
