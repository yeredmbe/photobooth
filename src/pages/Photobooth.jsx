...
À partir de 849$.</p>
      ...
      <div className='w-full flex items-center justify-center max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center mt-8 pt-8'>
        <div className='w-11/12 grid grid-cols-2 max-sm:grid-cols-1 gap-4 px-4'>
...
<div className="flex w-11/12 justify-evenly items-center max-sm:flex-col max-sm:items-center max-sm:justify-center my-5 max-sm:px-5">
<div 
